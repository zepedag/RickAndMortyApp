...
struct LocationsView: View {
    ...
    private let sampleCharacters: [CharacterBusinessModel] = [
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Earth (C-137)", url: ""),
            location: LocationBusinessModel(name: "Earth (C-137)", url: ""),
            image: "https://rickandmortyapi.com/api/character/avatar/1.jpeg",
            episodes: ["1", "2", "3"], url: "", created: ""
        ),
        CharacterBusinessModel(
            id: 2, name: "Morty Smith", status: .alive, species: "Human", type: "",
            gender: .male, origin: LocationBusinessModel(name: "Citadel of Ricks", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .female, origin: LocationBusinessModel(name: "Interdimensional Cable", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .female, origin: LocationBusinessModel(name: "Purge Planet", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Venzenulon 7", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .female, origin: LocationBusinessModel(name: "Bepis 9", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Cronenberg World", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Planet Squanch", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Giant's Town", url: ""),
        ...
        CharacterBusinessModel(
            ...
            gender: .male, origin: LocationBusinessModel(name: "Post-Apocalyptic Earth", url: ""),
    ...
    private var infoCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack {
                ...
                Text("Ubicaciones de Personajes").font(.headline).fontWeight(.semibold)
            }
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                HStack(spacing: 12) {
                    HStack(spacing: 4) {
                        ...
                        Text("Vivo").font(.caption2).foregroundColor(.secondary)
                    }
                    HStack(spacing: 4) {
                        Circle().fill(.red).frame(width: 12, height: 12)
                        Text("Muerto").font(.caption2).foregroundColor(.secondary)
                    }
                    HStack(spacing: 4) {
                        Circle().fill(.orange).frame(width: 12, height: 12)
                        Text("Desconocido").font(.caption2).foregroundColor(.secondary)
                    }
                }
            }

            HStack {
                Text("\(sampleCharacters.count) personajes").font(.caption).foregroundColor(.secondary)
                Spacer()
                Text("Coordenadas simuladas").font(.caption).foregroundColor(.secondary)
            }
        }
        .padding(16)
    ...
    private func getSimulatedLocation(for locationName: String) -> CLLocationCoordinate2D {
        ...
        case "earth (c-137)": return CLLocationCoordinate2D(latitude: 40.7128, longitude: -74.0060)
        case "citadel of ricks": return CLLocationCoordinate2D(latitude: 37.7749, longitude: -122.4194)
        case "unknown": return CLLocationCoordinate2D(latitude: 0.0, longitude: 0.0)
        case "interdimensional cable": return CLLocationCoordinate2D(latitude: 34.0522, longitude: -118.2437)
        case "purge planet": return CLLocationCoordinate2D(latitude: 25.7617, longitude: -80.1918)
        case "venzenulon 7": return CLLocationCoordinate2D(latitude: 51.5074, longitude: -0.1278)
        case "bepis 9": return CLLocationCoordinate2D(latitude: 48.8566, longitude: 2.3522)
        case "cronenberg world": return CLLocationCoordinate2D(latitude: 35.6762, longitude: 139.6503)
        case "planet squanch": return CLLocationCoordinate2D(latitude: -33.8688, longitude: 151.2093)
...
#Preview {
    LocationsView().environmentObject(Router())
}
